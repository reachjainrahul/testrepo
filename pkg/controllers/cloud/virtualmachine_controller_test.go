...
import (
	...
	testing2 "antrea.io/antreacloud/pkg/testing"
...
var _ = Describe("VirtualmachineController", func() {
	...
	BeforeEach(func() {
		...
		externalEntitySources, _ = testing2.SetupExternalEntitySources(networkInterfaceIPAddresses, namedports, testNamespace)
	})
